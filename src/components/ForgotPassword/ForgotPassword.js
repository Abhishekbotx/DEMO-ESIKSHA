...
//     e.preventDefault();
//     // Logic to send the verification code to the provided email
//     console.log('Email submitted:', email);
//   };
...
//     >
//       <h1 className="text-4xl font-bold mb-8">Forgot Password</h1>
//       <div className="bg-white p-8 rounded-lg shadow-md max-w-md w-full ml-20 mr-20">
//         <h2 className="text-2xl font-bold mb-4 text-center">Forgot Password</h2>
//         <p className="text-gray-600 mb-6 text-center">
//           Enter your email for the verification process, <br /> we will send a 4
